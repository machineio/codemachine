...
fun.strings = {
    ...
    ioFunBanner: "A Scalable Real-Time Communication  Platform",
    ioFunLandingText: "Powerful organization, account management, record, call, cast and review task on inbound and outbound campaigns.",
    ...
    powerComCamColIntAndS: "With our platform you are available to create, register and manage users, organizations profiles & Tasks",
    bcastMsgsThsndsCnts: "Campaings",
    sndVoiceMsgsCnts: "We offer integrated design, administration, and platform technology services for the development of successful loyalty programs that will become vital elements of your company’s marketing programs",
    orgToolMonkeys: "Reports",
    orgToolMonkeyDescription: "Our Data Center offers cloud-based services ranging from web site hosting and cloud applications to application virtualization, infrastructure administration, and colocation",
    ...
    useFunEnterprise: "Use Code Machine Enterprise, the best way to manage communications, on your servers",
